...
/**
 * Global class for all SapcommCore constants. You can add global constants for your extension into this class.
 */
public final class SapcommCoreConstants extends GeneratedSapcommCoreConstants
{
	public static final String EXTENSIONNAME = "sapcommcore";


	private SapcommCoreConstants()
	{
		//empty
	}

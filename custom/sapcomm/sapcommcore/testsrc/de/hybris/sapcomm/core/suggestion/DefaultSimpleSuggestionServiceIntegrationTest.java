 ...
 */
package de.hybris.sapcomm.core.suggestion;
...
import de.hybris.sapcomm.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/sapcommcore/test/testSimpleSuggestionService.csv", "utf-8");
	}

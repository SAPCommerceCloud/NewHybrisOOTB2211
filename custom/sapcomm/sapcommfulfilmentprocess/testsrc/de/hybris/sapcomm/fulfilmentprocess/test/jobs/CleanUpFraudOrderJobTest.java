 ...
 */
package de.hybris.sapcomm.fulfilmentprocess.test.jobs;
...
import de.hybris.sapcomm.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = SapcommFulfilmentProcessConstants.ORDER_PROCESS_NAME;

 ...
 */
package de.hybris.sapcomm.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SapcommFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SapcommFulfilmentProcessConstants.PARENT_PROCESS);

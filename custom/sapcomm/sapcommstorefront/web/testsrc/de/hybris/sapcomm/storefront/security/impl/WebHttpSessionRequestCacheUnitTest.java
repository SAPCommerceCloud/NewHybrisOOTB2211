...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sapcommstorefront/electronics/en",
						"https://electronics.local:9002/sapcommstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sapcommstorefront/electronics/en",
						"https://electronics.local:9002/sapcommstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sapcommstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sapcommstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sapcommstorefront/electronics/en",
						"https://electronics.local:9002/sapcommstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sapcommstorefront",
						"https://electronics.local:9002/sapcommstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sapcommstorefront",
						"https://electronics.local:9002/sapcommstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sapcommstorefront/electronics/en",
						"https://electronics.local:9002/sapcommstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

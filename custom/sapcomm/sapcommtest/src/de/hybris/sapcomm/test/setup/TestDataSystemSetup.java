 ...
 */
package de.hybris.sapcomm.test.setup;
...
import de.hybris.sapcomm.test.constants.SapcommTestConstants;
import de.hybris.sapcomm.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SapcommTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sapcommtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sapcommtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/sapcommtest/import/cstickets.impex");
			...
			importImpexFile(context, "/sapcommtest/import/csquotes.impex");
		}
	}
}
